...
abstract class AbstractTest
{
    ...
    protected TestCase[] testCases = {
        new TestCase("GET", "/api/v1/test", ""),
        new TestCase("GET", "/api/v1/test?foo=bar", ""),
        new TestCase("GET", "/api/v1/test?foo=bar&a[a]=1", ""),
        new TestCase("POST", "/api/v1/test", "{\"foo\":\"bar\"}"),
        new TestCase("POST", "/api/v1/test", "{\"foo\":1}"),
        new TestCase("POST", "/api/v1/test", "{\"foo\":false}"),
        new TestCase("POST", "/api/v1/test", "{\"foo\":1.023}"),
        new TestCase("DELETE", "/api/v1/test", "{\"alpha\": [\"a\", \"b\", \"c\"],\"obj\": {\"ints\": [1, 2, 3],\"floats\": [0.0, 1.1, 1.2, 1.3],\"bools\": [true, false],\"nil\": null,\"int\": 13,\"float\": 3.1415,\"bool\": true,\"nesting\": {\"nested\": true}}}"),
        new TestCase("DELETE", "/api/v1/test?foo=bar", "{\"alpha\": [\"a\", \"b\", \"c\"],\"obj\": {\"ints\": [1, 2, 3],\"floats\": [0.0, 1.1, 1.2, 1.3],\"bools\": [true, false],\"nil\": null,\"int\": 13,\"float\": 3.1415,\"bool\": true,\"nesting\": {\"nested\": true}}}"),
    };

    protected String[] v1SignatureResults = {
    ...
    protected String[] v2SignatureResults = {
    ...
    protected String[] v1HMACHeaders = {
    ...
    protected String[] v2HMACHeaders = {
